        ...
        <main>
            ...
            <div className="container  mx-5 px-4">
                    <div className="row">
                        ...
                        <div className="projects--overview--col col-md container mt-3">
                            <div>ZOFFICE represents an upgraded office interface that extends remote working to the modern workforce even after the global pandemic is over. Central to the design of ZOFFICE is extending the human touch and warmth offered by physical office to virtual office. Staff will be able to see their colleagues’ avatars being seated next to them, sharing a sense of mutual presence even in the virtual office.</div><br/>
                            <div>Through dynamically switching WebRTC on every 15 minutes, we are able to capture the imagery and verify the presence of a staff through artificial intelligence empowered by a face recognition API. This enable the system to provide the transparency of staff’s presence to everyone, during the office hours, even when some staffs are working remotely. We seek to protect the reasonable privacy of staff, such that the camera is off most of the time.</div><br/>
